...
use crate::infrastructure::zk::trusted_setup::generate_snark_keys_to_files;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    generate_snark_keys_to_files(pk_path, vk_path, patient_repo.find_all_ids().await.unwrap())?;
